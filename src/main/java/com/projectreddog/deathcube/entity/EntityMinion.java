...
public class EntityMinion extends EntityZombie implements IRangedAttackMob {
	...
	public EntityMinion(World world) {
		...
		this.tasks.addTask(2, new EntityAIArrowAttack(this, 0, 10, 10));// should act like a skely
		this.tasks.addTask(1, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
		this.tasks.addTask(0, new EntityAIMoveTowardsTarget(this, this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).getAttributeValue(), (float) this.getEntityAttribute(SharedMonsterAttributes.followRange).getAttributeValue()));
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(.05d);
