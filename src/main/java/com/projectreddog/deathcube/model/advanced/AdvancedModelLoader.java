package com.projectreddog.deathcube.model.advanced;
...
import com.projectreddog.deathcube.model.advanced.obj.ObjModelLoader;

/**
 * Common interface for advanced model loading from files, based on file suffix
 * Model support can be queried through the {@link #getSupportedSuffixes()} method. Instances can be created by calling {@link #loadModel(String)} with a
 * class-loadable-path
 *
 * @author cpw
 *
